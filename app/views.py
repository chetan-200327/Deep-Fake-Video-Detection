...
class CustomLSTM(tf.keras.layers.LSTM):
    def __init__(self, *args, **kwargs):
        # Remove the time_major parameter if present
...
model = tf.keras.models.load_model(
    'models/deepfake_detection_model.h5',
    custom_objects={'LSTM': CustomLSTM}
)

# model = tf.keras.models.load_model('models/deepfake_detection_model.h5',compile=False)
